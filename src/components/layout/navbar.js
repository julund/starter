...
export default function Navbar() {
  ...
  return (
      <nav className="sticky top-0 flex flex-wrap items-center justify-between p-4 gray-200 font-title">
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between gap-2">
          <div className="w-full relative flex justify-between items-center md:w-auto md:static md:block md:justify-start mr-2 md:mr-6">
            <Link className="inline-block whitespace-no-wrap" href="/" type="nav">Starter</Link>
          ...
          <div className={"md:flex flex-col md:flex-row flex-grow items-center gap-2 md:gap-6" + (navbarOpen ? " flex" : " hidden")}>
              <Link className="items-center" href="/services" type="nav">Services</Link>
              <Link className="items-center" href="/about-us" type="nav">About us</Link>
              <Link className="items-center" href="/contact" type="nav">Contact</Link>
          </div>
        </div>
      </nav>
  );
